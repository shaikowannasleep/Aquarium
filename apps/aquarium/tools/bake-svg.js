...
function renderSchool(school, schoolIndex) {
  ...
  for (let i = 0; i < school.count; i++) {
    ...
    if (school.depth === 'mid') localX += localX >= 0 ? 112 : -112;
...
function angelPalace() {
  ...
  return '<g id="cartoonPalace" stroke="#80b8b6" stroke-width="2.2" stroke-linejoin="round">' +
    ...
    '<g fill="#17384f" stroke="#a1cfca"><path d="M0 320 V64 Q26 35 52 64 V320Z"/><path d="M828 320 V64 Q854 35 880 64 V320Z"/></g>' +
    ...
    '<g transform="translate(440 91)" fill="#86b7af" stroke="#c4e2cf"><circle cy="-8" r="13" fill="#e7cf88"/>' +
